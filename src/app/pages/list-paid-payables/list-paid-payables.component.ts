...
@Component({
  selector: 'app-list-paid-payables',
  standalone: true,
  ...
  templateUrl: './list-paid-payables.component.html',
  styleUrl: './list-paid-payables.component.css',
  providers: [{ provide: LOCALE_ID, useValue: 'pt-BR' }]
})
export class ListPaidPayablesComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.payableService.GetListPaidPayables().subscribe(returnApi => {
